...
![Nhận định cảm tính của con người với các kết quả tạo sinh](assets/blog_images/diffusion/2026-02-09--001-introduction-to-flow-and-diffusion-models-001.png)
...
![Quá trình tạo sinh hình ảnh](assets/blog_images/diffusion/2026-02-09--001-introduction-to-flow-and-diffusion-models-002.png)
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../assets/blog_images/diffusion/2026-02-09--001-introduction-to-flow-and-diffusion-models-003.png"
    style={{
      width: "50%",
      maxWidth: "400px",
      display: "block",
